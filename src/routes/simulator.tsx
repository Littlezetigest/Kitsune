...
function WarRoomSimulator() {
  ...
  const generateInvestorResponse = async (userMessage: string): Promise<{ response: string; effectiveness: number }> => {
    if (!selectedAnalysis) return { response: "I need more information.", effectiveness: 5 };
